...
**Formål:** Indgangsdokumentet til TimeLapse Pro-dokumentationen. Læs dette først når du starter en ny session (Claude, Codex eller menneske). Det peger på den seneste, autoritative version af hvert dokument (`\*\_v10.md`), de levende arbejdsdokumenter og den underliggende empiri. **Sidst opdateret:** 2026-09-25 (ChatGPT: AI-provider-arkitektur/PR #258 pointer tilføjet; øvrig indeksstruktur bevaret) **Vedligeholdelsesregel:** Én seneste version pr. dokument, vedligeholdt som `.md`. Ved væsentlig opdatering hæves versionen og forgængeren flyttes til `Gamle versioner/`. Opdatér denne fil når nye autoritative dokumenter kommer til.
