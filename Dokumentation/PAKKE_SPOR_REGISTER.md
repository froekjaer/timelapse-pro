...
- **Næste handling:** Verificér CI på seneste code-head; kør provider capability smoke på Headend. Derefter corpus/resource/GRC gates før merge/defaultændring.
