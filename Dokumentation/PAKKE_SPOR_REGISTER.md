...
- **Næste handling:** Verificér frisk CI og lav en kort fysisk UX-check af provider-policy panelet. Kør derefter AI-provider GRC-import på Headend, efterfulgt af corpus/resource gates før merge/defaultændring.
