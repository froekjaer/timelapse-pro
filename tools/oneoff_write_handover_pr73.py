...
p = Path("Dokumentation/HANDOVER_LOG.md")
text = p.read_text(encoding="utf-8")
anchor = "## Log\n\n"
if text.count(anchor) != 1:
    raise SystemExit(f"handover log anchor count={text.count(anchor)}")

entry = """### Handover 2026-08-17 12:32 — fra ChatGPT til Peter/Claude/Codex: SEC-ZAI-05/15 Edge SSH private-key ownership closure (#73)
...
if "SEC-ZAI-05/15 Edge SSH private-key ownership closure (#73)" in text:
